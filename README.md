...
- Настройка папки загрузки и cookies; выбор качества (аудио, 360p, 480p, 720p, 1080p или максимум).
...
2. При желании выберите папку или задайте cookies/качество в «Настройки».
